...
**Apple Silicon:**
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.4.7/hetzner-k3s-macos-arm64
...
**Intel:**
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.4.7/hetzner-k3s-macos-amd64
...
[Homebrew](https://brew.sh/) works on Linux as well as macOS.
...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.4.7/hetzner-k3s-linux-amd64
...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.4.7/hetzner-k3s-linux-arm64
