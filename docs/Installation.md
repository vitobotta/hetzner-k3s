...
**Apple Silicon:**
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.6.0/hetzner-k3s-macos-arm64
...
**Intel:**
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.6.0/hetzner-k3s-macos-amd64
...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.6.0/hetzner-k3s-linux-arm64
