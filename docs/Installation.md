...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.0.7/hetzner-k3s-macos-amd64
...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.0.7/hetzner-k3s-macos-arm64
...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.0.7/hetzner-k3s-linux-amd64
...
```bash
wget https://github.com/vitobotta/hetzner-k3s/releases/download/v2.0.7/hetzner-k3s-linux-arm64
